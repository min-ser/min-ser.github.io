...
# kubectl만 설치 진행
jenkins-agent@Jenkins-Agent:~$ sudo apt-get install -y kubectl
...
Fetched 10.6 MB in 0s (23.4 MB/s)
Selecting previously unselected package kubectl.
(Reading database ... 78607 files and directories currently installed.)
