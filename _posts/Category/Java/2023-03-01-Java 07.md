...
## 변수 타입의 종류
![변수](/assets/category/Java/2023/03/09/1-변수타입과종류.png)
![변수](/assets/category/Azure/2023/02/27/ver1.drawio.png)
## 기본형의 종류와 크기
![변수](/assets/category/Java/2023/03/09/2-기본형의 종류와크기.jpg)

## 표현가능 범위
![변수](/assets/category/Java/2023/03/09/3-표현가능범위.PNG)