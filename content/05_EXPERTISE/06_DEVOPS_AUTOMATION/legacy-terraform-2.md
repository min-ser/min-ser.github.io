...
featured: false
summary: 'VSCODE 실행 후 명령어 팔레트 실행 VS code에서 명령어 팔레트 Command Palette 의 단축키 : Ctrl +
  Shift + P 팔레트를 이용한 로그인 Azure:Sign In 계정 선택 img /assets/category/Azure/2023/01/'
tags:
- Terraform
---
