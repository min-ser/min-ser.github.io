...
featured: false
summary: 'Spring Boot DB Read/Write 분기처리 1. Spring Boot Project 생성 Spring Boot ver
  : 2.7 JDK : 11 war, jar 상관없음 DB Azure Database For MySQL master master 복재 rea'
tags:
- SpringBoot
---
