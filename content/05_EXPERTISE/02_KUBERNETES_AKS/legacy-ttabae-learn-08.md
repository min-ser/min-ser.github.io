---
id: legacy-ttabae-learn-08
type: expertise
title: '[08/36] 4-2. 쿠버네티스 아키텍처 - namespace'
enabled: true
sample: false
group: kubernetes-aks
category: Kubernetes Fundamentals
createdDate: '2023-01-04'
updatedDate: '2023-01-04'
featured: false
summary: <iframe width="560" height="315" src="https://www.youtube.com/embed/pfkx8KDAZyk?list=PLApuRlvrZKohaBHvXAOhUD
  RxD0uQ3z0c" title=" 따배쿠 4 2. 쿠버네티스 아키텍처 n
tags:
- 따배쿠
---
...
failed for user engineer@example.com. Ensure that you have authenticated with a developer tool that supports Azure single sign on.'

Account                   SubscriptionName TenantId                             Environment
-------                   ---------------- --------                             -----------
engineer@example.com kms-limited      xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx AzureCloud
```
