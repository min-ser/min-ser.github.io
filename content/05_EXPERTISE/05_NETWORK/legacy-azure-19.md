...
featured: false
summary: '자습서: Azure Portal에서 사이트 간 VPN 연결 만들기 https://learn.microsoft.com/ko kr/azure/vpn
  gateway/tutorial site to site portal <a name="tutorial create a site '
tags:
- Azure
---
...
:::image type="content" source="/assets/owner/blog/thumbs/thumb01.png" alt-text="VNet 및 VPN 게이트웨이 다이어그램":::
...
<image type="content" source="/assets/owner/blog/thumbs/thumb01.png" alt-text="개요 페이지">
