...
featured: false
summary: Retrieval Retrieval 개념 LangChain이나 자연어 처리에서 사용자가 입력한 질문 query 에 대해 외부 데이터베이스나
  문서 저장소 등에서 관련 정보를 찾아오는 과정 특히 대형 언어 모델 LLM 은 훈련된 데이터에 기반하지만, 특정한 질문에 대한 답
tags:
- LangChain
---
