---
id: legacy-msa-inflearn-02
type: expertise
title: '[Section 2.] API Gateway Service'
enabled: true
sample: false
group: architecture-msa
category: MSA
createdDate: '2023-08-21'
updatedDate: '2023-08-21'
featured: false
summary: API Gateway Service API Gateway Service의 역할 proxy Cloud Architect img /assets/category/MSA/inflearn/02
  01.png 클라이언트 마이크로 서비스 간 직접 통신 client측에서 Microse
tags:
- MSA
- Legacy Note
---
