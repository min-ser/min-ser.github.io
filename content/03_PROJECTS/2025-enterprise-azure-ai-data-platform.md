---
id: enterprise-azure-ai-data-platform
type: project
title: "Enterprise Azure AI·Data Platform 구축 및 운영 고도화"
...
flowchart TB
 ...
 GIT --> AKS[AKS / Application Platform]
...
Microsoft Fabric 기술지원을 시작으로 Data Platform 프로젝트의 Azure Part PL 역할까지 담당 범위를 확대하여 Azure AI, Data Platform, AKS, Private Network, Security Governance, CI/CD 및 운영 자동화를 지원한 장기 프로젝트입니다.
...
- Data Platform / Application Platform Application, Batch, CronJob 서비스 구축·운영
...
이 프로젝트는 단일 Azure Resource 구축이 아니라 여러 Platform Workstream을 동시에 담당한 장기 운영/고도화 프로젝트입니다. 상세 구현은 동일 `careerId: cloud-platform-engineering`의 Project Record로 분리하여 Home → Career → Projects에서 자동 연결합니다.
...
## 11. Role Expansion
초기 투입 목적은 Microsoft Fabric 기술지원이었지만, 실제 프로젝트 진행 과정에서 Azure AI, AKS, Network, Identity, CI/CD, Security 요구가 연결되면서 담당 범위가 확대되었습니다. 이후 Data Platform의 **Azure Part PL** 역할로 Azure 영역의 기술 검토, 개발팀 지원, 고객 인프라/네트워크/보안 조직 협의 및 Microsoft 기술 협업까지 수행했습니다.
...
Career 화면과 Project 상세 화면 모두에서 Enterprise AI/Data Platform 수행 범위를 축약 없이 확인할 수 있도록 동일한 원천 경력 기록을 포함합니다.
