---
id: manufacturing-scm-devops
type: project
title: "Manufacturing SCM Enterprise SCM Apps & DevOps 서비스 구축"
...
---
# Manufacturing SCM Enterprise SCM Apps & DevOps 서비스 구축
...
## 01. Project Overview
Enterprise SCM 애플리케이션을 Azure App Service에 반복 가능하게 배포할 수 있도록 **GitHub Actions 기반 CI/CD Pipeline**을 구성하고 애플리케이션 Repository와 Azure 배포 대상 간 연계를 지원했습니다.
