...
id: genai360
type: project
title: "GenAI360 — AWS 기반 생성형 AI 플랫폼의 Azure 전환 기술지원"
...
이 경험은 이후 삼성증권의 금융권 생성형 AI Platform과 아모레퍼시픽 Azure AI/Data Platform 업무로 이어지는 **Application Architecture → Enterprise AI Platform Engineering 전환 구간**으로 기록합니다.
