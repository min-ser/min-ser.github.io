---
id: healthcare-platform-support
type: project
title: "B2B/B2C 통합 플랫폼 DB HA·AKS 기술검증 및 구축지원"
...
---
# B2B/B2C 통합 플랫폼 DB HA·AKS 기술검증 및 구축지원
...
Healthcare Platform B2B/B2C 통합 플랫폼 구축 과정에 참여하여 고객 환경에 상주하며 **AKS Application 배포, Database HA/Replica 기능검증, Forward/Reverse Proxy Troubleshooting, WAF 적용지원, Spring Boot 기반 검증 Application 개발 및 운영 가이드 작성**을 수행했습니다.
...
- Healthcare Platform 고객 환경 상주 기술지원
