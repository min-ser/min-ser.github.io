...
type: career
company: "Cloud & AI Platform Engineering"
organization: Cloud & AI Engineering Organization
position: Manager
startDate: "2022-07-01"
endDate: null
status: ongoing
featured: true
client: Enterprise AI/Data Platform
...
현재 Enterprise AI/Data Platform Data Platform 프로젝트에서는 **Azure AI Platform Engineer / Azure Part PL / Azure SME** 역할로 Azure AI, AKS, Microsoft Fabric 영역의 기술 검토와 구축·운영을 담당합니다. 개발팀뿐 아니라 고객사 인프라·네트워크·보안 조직 및 Microsoft와 협업하며 서비스 도입 검토부터 Private Connectivity, Identity/RBAC, CI/CD, Monitoring, Troubleshooting까지 플랫폼 전반을 지원합니다.
...
### Enterprise AI/Data Platform Platform Engineering Map

```mermaid
flowchart TB
 PL[Data Platform<br/>Azure Part PL / Azure SME]
 AI[Azure AI Platform<br/>Foundry · OpenAI · AI Search · APIM]
 FAB[Microsoft Fabric<br/>Capacity · Workspace · CI/CD · Audit]
 AKS[AKS / Application Platform<br/>Application · Batch · CronJob · GitOps]
...
### Enterprise AI/Data Platform Engineering Workstreams
...
| AKS / Application Platform | GitLab, ACR, Helm, ArgoCD, Workload Identity | 신규 7개 서비스 구축 |
...
- Data Platform 프로젝트 Azure Part PL로 Azure 영역 기술 검토 및 업무 조율
...
```mermaid
timeline
 title Cloud & AI Platform Engineering Project Timeline
 2023 : Azure Cloud Management API : Commerce Service Azure Infra : Healthcare Platform B2B/B2C : Manufacturing SCM DevOps
 2024 : Construction Domain Azure Functions : 보험 Application Cloud 전환 제안 : Digital Service Migration : Enterprise GenAI Platform : 생성형 AI 서비스 AI Azure 전환 제안
 2025 : 생성형 AI 서비스 제안/HOL : 금융권 AI Platform : Enterprise AI/Data Platform Data Platform / Fabric
 2026 : Enterprise AI/Data Platform Azure Part PL : Fabric Autoscale / Audit / Security : Application Platform AKS / GitOps
```

## Major Engagements

### 1. Enterprise AI/Data Platform — Azure AI / Data Platform 구축 및 운영 고도화

**기간:** 2025.07 ~ 현재  
**소속:** Cloud & AI Platform Engineering  
**역할:** Azure AI Platform Engineer / Azure Part PL / Azure SME / Microsoft Fabric·AKS 담당

Microsoft Fabric 기술지원을 목적으로 프로젝트에 투입되었으며, 프로젝트 진행 과정에서 Azure AI, AKS, Network, Identity, Security, CI/CD 및 운영 자동화 영역으로 담당 범위가 확대되었습니다. 현재는 **Data Platform 프로젝트 Azure Part PL**로 Azure 영역의 기술 검토와 운영방안 수립을 지원하고, Microsoft Fabric 플랫폼과 Data Platform/Application Platform의 AKS 서비스 구축·운영을 함께 담당하고 있습니다.
...
- Data Platform 프로젝트 Azure 파트 담당 및 Azure 영역 기술 검토·업무 조율
...
#### Data Platform 프로젝트 [Main] — Microsoft Fabric / Azure AI / Platform Engineering
...
- PRD `prod-fabric-capacity` Capacity에서 F32 상태와 Rolling 평균을 분석하여 **SCALE_DOWN → F16** 실제 동작 검증
...
#### Application Platform 프로젝트 — 신규 AKS Service Platform 구축

**역할:** AKS / Azure 담당

Application Platform 프로젝트의 Application / Batch / CronJob을 포함한 **총 7개 신규 서비스**를 기존 AKS 환경에 구성하고, CI/CD와 Azure Resource 및 Microsoft Fabric 연계를 담당했습니다.
...
- Microsoft Fabric 단일 기술지원으로 투입된 이후 **Data Platform Azure Part PL / Azure SME**로 역할 확대
...
- Application Platform 프로젝트의 Application / Batch / CronJob **총 7개 신규 AKS 서비스 구축**
...
### 3. 생성형 AI 서비스 — AI 서비스 Azure 전환 제안 기술지원

**기간:** 2024.12 ~ 2025.02  
**구분:** Pre-Sales / Proposal / Technical Documentation  

생성형 AI 서비스 AI 서비스 Azure 전환 제안 준비 과정에서 Azure OpenAI, Azure AI Search, APIM, Azure Functions, Azure DevOps를 연결하는 **AOAI CI/CD 구축 HOL을 직접 작성**했습니다. Self-hosted Agent/Agent Pool/Pipeline과 Application Test 절차까지 문서화했으나 실제 고객 구축 단계까지 수행한 프로젝트는 아니므로 Delivery 경력과 명확히 구분합니다. Terraform은 문서상 준비도구로 확인되지만 실제 Production IaC 수행으로 기록하지 않습니다.
...
### 5. Digital Service — Azure Sponsorship → CSP Subscription Migration
...
### 6. 보험 Application — 클라우드 전환 2차 사업 제안 기술지원

**기간:** 2024.07 ~ 2024.08  
**구분:** Pre-Sales / RFP / Proposal  
**협업:** 대형 SI 파트너

대형 SI 파트너와 공동으로 보험 Application Cloud 전환 2차 사업 제안에 참여했습니다. 11개 Application의 Azure To-Be Architecture와 AKS/App Service 전환방안, Network/DR/Data 영역을 검토하고 제안서/발표자료 작성 및 Jenkins Build Agent 사전검증을 수행했습니다. 실제 구축 단계에는 참여하지 않았으므로 Pre-Sales 경력으로 구분합니다.

### 7. Construction Domain — Azure Functions 기술 가이드

Azure Functions의 HTTP/Timer/Blob Trigger와 Managed Identity 등을 대상으로 Hands-on 및 개발 가이드를 지원했습니다.

### 8. Construction Domain — Azure Functions 개발·배포 기술가이드
...
### 9. Healthcare Platform — B2B/B2C 통합 플랫폼 구축 기술지원
...
### 10. Commerce Service — Azure 인프라 구축·운영 및 서비스 안정화
...
### 11. Azure Cloud Management — API 개발 기술지원
...
### 12. Manufacturing SCM — Enterprise SCM Apps & DevOps 서비스 구축
...
Cloud & AI Platform Engineering 재직 기간 동안 담당 영역은 다음과 같이 확장되었습니다.
...
- **2026 — Azure Part PL / Platform Engineering:** Fabric CI/CD·Private Connectivity·Autoscale·Audit, Application Platform AKS/GitOps, Security Governance 및 복합 장애 대응
...
- `03_PROJECTS/2025-enterprise-azure-ai-data-platform.md` — Enterprise AI/Data Platform Azure AI / Data / AKS Platform Engineering 종합 기록
...
- `03_PROJECTS/enterprise-aks-platform.md` — Application Platform 신규 AKS 서비스와 GitOps 운영
- `07_ARCHIVE/2026-enterprise-troubleshooting-archive.md` — 실제 장애 분석/조치 이력
