---
id: hotel-pms-engineering
type: career
company: "Hotel PMS Engineering & Operations"
...
# Hotel PMS Engineering

> **Hotel PMS System Operations & Development**  
> 2019.04 — 2020.04

호텔 PMS(Property Management System)를 개발·운영하는 Hotel PMS Engineering에서 **상용 PMS 시스템의 구축·운영·배포·데이터베이스 관리 및 장애 대응 업무**를 수행했습니다.
...
Hotel PMS Engineering에서는 특정 개발 기능 하나를 담당하기보다 **실제 사용자가 존재하는 상용 시스템을 구축하고 운영하며 장애를 해결하는 경험**을 쌓았습니다. Application만 보는 것이 아니라 Server, Web, Container, Database, Deployment 영역을 함께 확인하는 현재 Platform Engineering 관점으로 이어진 초기 시스템 운영 경험입니다.
