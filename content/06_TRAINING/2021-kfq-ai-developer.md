...
id: kfq-ai-developer
type: training
title: 프로젝트기반 인공지능 개발자 양성과정
institution: 한국품질재단
startDate: "2021-04-01"
endDate: "2021-10-01"
status: completed
enabled: true
focus: "Python / Data Analysis / Django / AI / Deep Learning / Computer Vision"
skills:
  - Python
  - Data Analysis
  - Django
  ...
  - OpenCV
repositories:
  - https://github.com/min-ser/KFQ
  - https://github.com/min-ser/KFQ_AI_2TH_DJANGO
  - https://github.com/min-ser/autonomous-surveillance-robot
projectIds:
  - kfq-django-web
  - kfq-final-robot
---
...
flowchart LR
 ...
 B --> C[Web Application]
 C --> D[Image Processing / OpenCV]
 D --> E[AI / Deep Learning]
 E --> F[Computer Vision]
 F --> G[Autonomous Surveillance Robot]
```
...
```mermaid
flowchart LR
 USER[User] --> DJANGO[Django Web]
 DJANGO --> APP[Application Logic]
 APP --> DATA[(Data)]
```

AI/Data 실습 결과를 Web Application과 연결하는 중간 단계의 프로젝트로 Git Blog에서는 별도의 Project Markdown과 연결합니다.
...
```mermaid
flowchart LR
 CAMERA[Camera / Video Stream] --> CV[Computer Vision]
 CV --> FACE[Face Recognition]
 CV --> OBJECT[Object Recognition]
 FACE --> SERVICE[Monitoring Service]
 OBJECT --> SERVICE
 SERVICE --> WEB[Django Web]
 WEB --> OPERATOR[Operator]
 WEB --> ROBOT[Robot Control]
```
...
```mermaid
flowchart LR
 KFQ[KFQ\nLearning Repository] --> DJ[KFQ_AI_2TH_DJANGO\nWeb Project]
 DJ --> FINAL[autonomous-surveillance-robot\nFinal Project]
```
